        ...
        <div>
            <div id="table">
                <div style="margin-bottom: 10px">
                    ...
                    <el-button size="mini" :loading="loading" @click="deleteSysLog">删除</el-button>
                </div>
                <i-table ref="iTable" 
        ...
        return {
            ...
            tableTitle: [
                ...
                {prop: 'operation', label: '操作', fixed: 'right', width: 90,
                    operation: [
                        {name: '查看', style: 'text', clickFun: this.viewSysLog},
                        {name: '修改', style: 'text', clickFun: this.editViewSysLog},
                    ]
                }
            ],
            tableData: [],
