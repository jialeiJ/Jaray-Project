/*
 ...
 Source Server         : CentOS192.168.1.104
...
CREATE TABLE `annex`  (
  `fid` int NOT NULL AUTO_INCREMENT COMMENT '附件主键id',
...
CREATE TABLE `decision`  (
  `did` int NOT NULL COMMENT '决策主键id',
...
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 CHECKSUM = 1 COLLATE = utf8_general_ci COMMENT = '序列表，命名s_[table_name]_id' DELAY_KEY_WRITE = 1 ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sequence
-- ----------------------------
INSERT INTO `sequence` VALUES ('s_complaint_id', 24, 1);
INSERT INTO `sequence` VALUES ('s_sys_user_id', 10, 1);
INSERT INTO `sequence` VALUES ('s_sys_user_role_id', 0, 1);
INSERT INTO `sequence` VALUES ('s_sys_menu_id', 0, 1);
INSERT INTO `sequence` VALUES ('s_sys_role_id', 2, 1);
INSERT INTO `sequence` VALUES ('s_sys_log_id', 0, 1);
INSERT INTO `sequence` VALUES ('s_sys_dict_id', 0, 1);
INSERT INTO `sequence` VALUES ('s_sys_dept_id', 0, 1);
...
CREATE TABLE `sys_dept`  (
  ...
  `parent_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '上级机构ID，一级机构为0',
  ...
  `last_update_time` varchar(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  `del_flag` tinyint NULL DEFAULT 0 COMMENT '是否删除  -1：已删除  0：正常',
  UNIQUE INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '机构管理' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_dict
-- ----------------------------
INSERT INTO `sys_dict` VALUES ('3', 'male', '男', 'sex', '性别', 0, 'admin', '2018-09-23 19:52:54', '', '', '性别', 0);
...
CREATE TABLE `sys_log`  (
  ...
  `time` varchar(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '执行时长(毫秒)',
...
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES ('1071', 'admin', '查询', 'com.louis.kitty.admin.sevice.impl.SysDictServiceImpl.findPage()', '{\"columnFilters\":{\"label\":{\"name\":\"label\",\"value\":\"\"}},\"pageNum\":1,\"pageSize\":8}', '4', '0:0:0:0:0:0:0:1', 'admin', '2018-09-23 19:54:16', '', '');
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('1', '系统管理', '0', '', 0, 'el-icon-setting', 0, '', '2020-06-22 23:28:40', '', '2020-06-22 23:28:42', 0);
INSERT INTO `sys_menu` VALUES ('2', '用户管理', '1', '/sys/user', 1, 'el-icon-service', 1, NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES ('28', '使用案例', '0', NULL, 0, 'el-icon-picture-outline', 6, NULL, NULL, 'admin', '2018-11-15 14:39:43', 0);
INSERT INTO `sys_menu` VALUES ('29', '国际化', '28', '/demo/i18n', 1, 'el-icon-edit', 1, NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES ('3', '机构管理', '1', '/sys/dept', 1, 'el-icon-news', 2, NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES ('30', '换皮肤', '28', '/demo/theme', 1, 'el-icon-picture', 2, NULL, NULL, NULL, NULL, 0);
INSERT INTO `sys_menu` VALUES ('35', '接口文档', '0', 'http://localhost:8080/swagger-ui.html', 1, 'el-icon-document', 3, NULL, NULL, 'admin', '2018-12-27 11:04:18', 0);
...
INSERT INTO `sys_menu` VALUES ('45', '投诉', '1', '/complaint', 1, 'el-icon-s-promotion', 0, '', '2020-06-22 23:50:52', '', '2020-06-22 23:50:54', 0);
...
INSERT INTO `sys_menu` VALUES ('8', '系统日志', '1', '/sys/log', 1, 'el-icon-info', 8, NULL, NULL, 'admin', '2018-09-23 19:32:28', 0);
INSERT INTO `sys_menu` VALUES ('M2020062200000', NULL, '0', NULL, 0, NULL, 0, NULL, NULL, NULL, NULL, 0);
...
CREATE TABLE `sys_perm`  (
  ...
  `perm` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '授权',
...
-- Records of sys_perm
-- ----------------------------
INSERT INTO `sys_perm` VALUES ('P10', '新增', 'ROLE_ADD', NULL);
INSERT INTO `sys_perm` VALUES ('P20', '修改', 'ROLE_EDIT', NULL);
INSERT INTO `sys_perm` VALUES ('P30', '删除', 'ROLE_DELETE', NULL);
INSERT INTO `sys_perm` VALUES ('P40', '查看', 'ROLE_VIEW', NULL);
INSERT INTO `sys_perm` VALUES ('P50', '导出', 'ROLE_EXPORT', NULL);
INSERT INTO `sys_perm` VALUES ('P60', '导入', 'ROLE_IMPORT', NULL);
...
-- ----------------------------
INSERT INTO `sys_role_perm` VALUES ('10', '新增', 'sys:user:add', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('11', '修改', 'sys:user:edit', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('12', '删除', 'sys:user:delete', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('13', '查看', 'sys:dept:view', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('14', '新增', 'sys:dept:add', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('15', '修改', 'sys:dept:edit', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('16', '删除', 'sys:dept:delete', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('17', '查看', 'sys:role:view', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('18', '新增', 'sys:role:add', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('19', '修改', 'sys:role:edit', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('20', '删除', 'sys:role:delete', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('21', '查看', 'sys:menu:view', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('22', '新增', 'sys:menu:add', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('23', '修改', 'sys:menu:edit', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('24', '删除', 'sys:menu:delete', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('31', '查看', 'sys:dict:view', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('32', '新增', 'sys:dict:add', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('33', '修改', 'sys:dict:edit', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('34', '删除', 'sys:dict:delete', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role_perm` VALUES ('9', '查看', 'sys:user:view', '2', NULL, NULL, NULL, NULL, NULL);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('2', 'admin', '$2a$10$Uf6A54EZZuFThoAiZ9WLEO.0MjDujZ.z.bRWwWAg1vJ9aPFRPivvy', '798358579@qq.com', '15029367158', 1, 33, 'admin', '2020-06-23 19:48:38', 'admin', '2020-06-23 19:49:02', 0);
INSERT INTO `sys_user` VALUES ('26', '典韦', 'fd80ebd493a655608dc893a9f897d845', 'test@qq.com', '13889700023', 1, 33, 'admin', '2018-09-23 19:45:48', 'admin', '2018-09-23 19:45:57', 0);
INSERT INTO `sys_user` VALUES ('22', '刘备', 'fd80ebd493a655608dc893a9f897d845', 'test@qq.com', '13889700023', 1, 34, 'admin', '2018-09-23 19:43:00', 'admin', '2018-11-04 10:12:45', 0);
INSERT INTO `sys_user` VALUES ('30', '周瑜', 'fd80ebd493a655608dc893a9f897d845', 'test@qq.com', '13889700023', 1, 35, 'admin', '2018-09-23 19:47:28', 'admin', '2018-09-23 19:48:04', 0);
INSERT INTO `sys_user` VALUES ('27', '夏侯惇', 'fd80ebd493a655608dc893a9f897d845', 'test@qq.com', '13889700023', 1, 33, 'admin', '2018-09-23 19:46:09', 'admin', '2018-09-23 19:46:17', 0);
INSERT INTO `sys_user` VALUES ('29', '孙权', 'fd80ebd493a655608dc893a9f897d845', 'test@qq.com', '13889700023', 1, 35, 'admin', '2018-09-23 19:46:54', 'admin', '2018-09-23 19:47:03', 0);
INSERT INTO `sys_user` VALUES ('25', '曹操', 'fd80ebd493a655608dc893a9f897d845', 'test@qq.com', '13889700023', 1, 33, 'admin', '2018-09-23 19:45:32', 'admin', '2018-09-23 19:45:37', 0);
INSERT INTO `sys_user` VALUES ('28', '荀彧', 'fd80ebd493a655608dc893a9f897d845', 'test@qq.com', '13889700023', 1, 33, 'admin', '2018-09-23 19:46:38', 'admin', '2018-11-04 15:33:17', 0);
INSERT INTO `sys_user` VALUES ('24', '诸葛亮', 'fd80ebd493a655608dc893a9f897d845', 'test@qq.com', '13889700023', 1, 34, 'admin', '2018-09-23 19:44:23', 'admin', '2018-09-23 19:44:29', 0);
INSERT INTO `sys_user` VALUES ('23', '赵云', 'fd80ebd493a655608dc893a9f897d845', 'test@qq.com', '13889700023', 1, 34, 'admin', '2018-09-23 19:43:44', 'admin', '2018-09-23 19:43:52', 0);
INSERT INTO `sys_user` VALUES ('31', '陆逊', 'fd80ebd493a655608dc893a9f897d845', 'test@qq.com', '13889700023', 1, 35, 'admin', '2018-09-23 19:47:44', 'admin', '2018-09-23 19:47:58', 0);
INSERT INTO `sys_user` VALUES ('32', '黄盖', 'fd80ebd493a655608dc893a9f897d845', 'test@qq.com', '13889700023', 1, 35, 'admin', '2018-09-23 19:48:38', 'admin', '2018-09-23 19:49:02', 0);
...
delimiter ;;
CREATE FUNCTION `currval`(seq_name_val VARCHAR(50))
 RETURNS int
  DETERMINISTIC
BEGIN  
    DECLARE VALUE INTEGER;  
    SET VALUE = 0;  
    SELECT current_val INTO VALUE FROM sequence WHERE `seq_name` = seq_name_val;  
    RETURN VALUE;  
END
;;
delimiter ;
...
delimiter ;;
CREATE FUNCTION `nextval`(seq_name_val VARCHAR(50))
 RETURNS int
  DETERMINISTIC
BEGIN  
    UPDATE sequence SET current_val = current_val + increment_val WHERE `seq_name` = seq_name_val;  
